  ...
  useEffect(() => {
    const fetchDiagnosis = async () => {
      try {
        ...
        const diagnosisResponse = await authFetch(`/api/student/courses/${courseId}/diagnosis`);
        ...
        const videoChart = new Chart(videoChartRef.current, {
          ...
          data: {
            ...
            datasets: [
              {
                data: [
                  diagnosisData.learningBehavior.videoLearning,
                  100 - diagnosisData.learningBehavior.videoLearning,
                ],
        ...
        const materialChart = new Chart(materialChartRef.current, {
          ...
          data: {
            ...
            datasets: [
              {
                data: [
                  diagnosisData.learningBehavior.materialLearning,
                  100 - diagnosisData.learningBehavior.materialLearning,
                ],
        ...
        const discussionChart = new Chart(discussionChartRef.current, {
          ...
          data: {
            ...
            datasets: [
              {
                data: [
                  diagnosisData.learningBehavior.discussion,
                  100 - diagnosisData.learningBehavior.discussion,
                ],
        ...
        const attendanceChart = new Chart(attendanceChartRef.current, {
          ...
          data: {
            ...
            datasets: [
              {
                data: [
                  diagnosisData.learningBehavior.attendance,
                  100 - diagnosisData.learningBehavior.attendance,
                ],
    ...
    <>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-8">
        ...
        {diagnosisData ? (
                ...
                <div className="md:ml-8">
                  <div className="mb-4">
                    ...
                    <div className="text-xl font-semibold text-gray-900">
                      {diagnosisData.predictedGrade}
                    </div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-500 mb-1">学习状态</div>
                    <div className="text-lg font-medium text-green-600">
                      {diagnosisData.totalScore >= 80
                        ? '优秀'
                        : diagnosisData.totalScore >= 60
                          ? '良好'
                          : '需要改进'}
                    </div>
                  </div>
              ...
              <div className="mt-6 bg-gray-50 p-4 rounded-lg border border-gray-200">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium text-blue-600">
                    {diagnosisData.learningBehavior.chapterStudyCount}
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                  ...
                  <div className="text-2xl font-semibold text-gray-900">
                    {diagnosisData.assignment.total_assignments}
                  </div>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                  <div className="text-sm text-gray-500 mb-1">已提交</div>
                  <div className="text-2xl font-semibold text-gray-900">
                    {diagnosisData.assignment.submitted_assignments}
                  </div>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                  <div className="text-sm text-gray-500 mb-1">提交率</div>
                  <div className="text-2xl font-semibold text-gray-900">
                    {diagnosisData.assignment.submission_rate}%
                  </div>
                </div>
              </div>
              <div className="mt-4 bg-gray-50 p-4 rounded-lg border border-gray-200">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium text-yellow-600">
                    {diagnosisData.assignment.avg_score}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="text-center py-12 text-gray-500">暂无学情数据</div>
        )}
      </div>
    </>
  );
